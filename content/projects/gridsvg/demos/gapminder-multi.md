...
{{< html >}}
<iframe class="gridsvg-embed gridsvg-embed--wide" src="gapminder-multi-panel.svg" loading="lazy" title="Animated Gapminder bubble plot (multi-panel by continent)"></iframe>
{{</ html >}}
