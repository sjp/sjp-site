...
{{< html >}}
<iframe class="gridsvg-embed gridsvg-embed--square" src="/projects/gridsvg/demos/gapminder-single/gapminder-single-panel.svg" loading="lazy" title="Animated Gapminder bubble plot (single panel)"></iframe>
{{</ html >}}
