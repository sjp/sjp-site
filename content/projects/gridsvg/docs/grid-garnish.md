...
{{< html >}}
<iframe class="gridsvg-embed gridsvg-embed--square" src="/projects/gridsvg/docs/grid-garnish-example.svg" loading="lazy" title="gridSVG grid.garnish interactivity example"></iframe>
{{</ html >}}
